...
from .FEU import feu
from .FEU_1 import feu_1
from .FEU_2 import feu_2
from .utils import *
...
class PyramidFeatures(nn.Module):
    def __init__(self, config, img_size=224, in_channels=3):
        ...
        self.feu = feu(96)
        self.feu_1 = feu_1(192)
        self.feu_2 = feu_2(384)
